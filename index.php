...
<body>
    ...
    <div align='center' id="ro">
        ...
        <div class="uk-child-width-expand@s uk-width-1-2@s uk-text-center" uk-grid>
            <div>
                <a href="index.php?page=<?= $pageCourante ?>&order=price&by=DESC" class="btn btn-primary btn-lg" role="button" aria-disabled="true">Prix decroissant</a>
            </div>
            <div>
            <a href="index.php?page=<?= $pageCourante ?>&order=price&by=ASC" class="btn btn-primary btn-lg" role="button" aria-disabled="true">Prix croissant</a>
            </div>
        </div>
        </center>
        <ul style="display:inline" class="uk-pagination uk-margin" uk-margin>
            <li style="float: left;"><a href="index.php?page=<?=$pageCourante-1?>" class="btn btn-primary btn-lg" role="button" aria-disabled="true"><< Page Precedente</a></li>
            <li style="float: right;"><a href="index.php?page=<?=$pageCourante+1?>" class="btn btn-primary btn-lg" role="button" aria-disabled="true">Page Suivante >></a></li>
        </ul>
